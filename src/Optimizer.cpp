...
PetscErrorCode Optimizer::SetInitialGuess(VecField* x) {
    ...
    PetscFunctionBegin;
    //PUSH_RANGE("Optimizer_SetInitialGuess",1)
...
PetscErrorCode Optimizer::SetProblem(Optimizer::OptProbType* optprob) {
    PetscErrorCode ierr = 0;
    PetscFunctionBegin;
    //PUSH_RANGE("Optimizer_SetProblem",1)
    this->m_Opt->Enter(__func__);
...
PetscErrorCode Optimizer::SetPreconditioner(Preconditioner* precond) {
    PetscErrorCode ierr = 0;
    PetscFunctionBegin;
    //PUSH_RANGE("Optimizer_SetPreconditioner",1)
    this->m_Opt->Enter(__func__);
...
PetscErrorCode Optimizer::SetupTao() {
    ...
    //PUSH_RANGE("Optimizer_SetupTao",1)
    this->m_Opt->Enter(__func__);
...
PetscErrorCode Optimizer::Run(bool presolve) {
    ...
    //PUSH_RANGE("Solve_Optimization_Problem",1)
...
PetscErrorCode Optimizer::GetSolution(Vec &x) {
    PetscErrorCode ierr;
    PetscFunctionBegin;
    //PUSH_RANGE("Optimizer_GetSolution",1)
    this->m_Opt->Enter(__func__);
...
PetscErrorCode Optimizer::GetSolutionStatus(bool &converged) {
    ...
    PetscFunctionBegin;
    //PUSH_RANGE("Optimizer_GetSolutionStatus",1)
    this->m_Opt->Enter(__func__);
